...
<br>
<form action=# >
  <button class="button1" data-toggle="modal" data-target="#myModal"><span>View Submitted Assignments</span></button>
</form>
</div>
</div>
    <div id="myModal" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="view_assignment.jsp" >
                          <strong>Assignment id: </strong>
                          <input type="text" name="ab"  maxlength=40 required>
                          <br><br>
                          <input type="submit" class="btn btn-info btn-lg" value="View">
                        </form>
                      </div>
